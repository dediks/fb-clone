  ...
  <div class="w-2/3 bg-white rounded shadow mt-6 overflow-hidden">
    <div class="flex flex-col p-4">
      <div class="flex items-center">
        ...
        <div class="ml-5">
          <div class="font-bold text-sm">{{ post.data.attributes.posted_by.data.attributes.name }}</div>
    ...
    <div class="w-full" v-if="post.data.attributes.image">
      <img :src="post.data.attributes.image" alt="Air terjun nglirip" class="w-full" />
    </div>

    <div class="flex justify-between px-4 text-gray-700 text-sm pt-2">
      <div class="flex">
    ...
    <div class="flex justify-between border-1 border-gray-400 m-4">
      <button
        class="flex justify-center py-2 rounded-lg text-sm w-full"
